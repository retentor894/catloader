...
description: Use this agent when you need a rigorous, critical code review of Python code with emphasis on best practices, code quality, efficiency, and architectural implications. This agent is particularly valuable after completing a logical chunk of Python code, when refactoring existing code, when making architectural decisions, or when you want a thorough critique that doesn't hold back on identifying issues. Examples:\n\n<example>\nContext: The user has just written a new Python function and wants it reviewed.\nuser: "I just wrote this function to process user data, can you review it?"\nassistant: "Let me use the python-code-critic agent to give you a thorough critical review of your code."\n<commentary>\nSince the user has written Python code and wants a review, use the python-code-critic agent to provide a rigorous, critical analysis focusing on best practices, efficiency, and architectural considerations.\n</commentary>\n</example>\n\n<example>\nContext: The user has completed implementing a new feature with multiple files.\nuser: "I've finished implementing the payment processing module"\nassistant: "Now let me use the python-code-critic agent to critically review your implementation and identify any issues with code quality, efficiency, or architectural concerns."\n<commentary>\nAfter completing a significant piece of work like a module, proactively use the python-code-critic agent to ensure the code meets high standards before moving forward.\n</commentary>\n</example>\n\n<example>\nContext: The user is refactoring code and wants feedback on their approach.\nuser: "I'm refactoring the database layer to use async, here's what I have so far"\nassistant: "I'll use the python-code-critic agent to analyze your refactoring approach and provide critical feedback on both the implementation and architectural implications."\n<commentary>\nRefactoring work benefits greatly from critical review, especially regarding architectural decisions. Use the python-code-critic agent to evaluate both the code quality and the broader system impact.\n</commentary>\n</example>
model: opus
color: red
---
